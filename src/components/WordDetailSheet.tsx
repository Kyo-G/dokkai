...
export default function WordDetailSheet({ wordInfo, articleId, sentenceId, existingWord, onClose }: Props) {
  ...
  async function loadAiDetails() {
    ...
    try {
      ...
      setAiError(e instanceof Error ? e.message : t.fetchFailed)
    } finally {
      setAiLoading(false)
    }
  }
      ...
      >
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-5">
          ...
          <section>
            ...
            >
              <span className="text-xs uppercase tracking-wide font-medium">{t.aiUsage}</span>
              {aiLoading
